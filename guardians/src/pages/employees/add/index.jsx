...
const AddEmployee = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            doormanCourse: Yup.string().required('Course is required'),
            ...
            cprnumber:  Yup.string().matches(/^[0-9]{6,10}$/, 'CPR number must be between 6 and 10 digits').required('CPR number is required').typeError('Must be a number'),
